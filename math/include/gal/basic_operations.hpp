...
namespace gal::toolbox::math
{
	...
	*/
	...
	public:
		...
		constexpr static bool operator_equal_to(value_type v1, U v2, value_type epsilon = FLT_EPSILON)
				noexcept(std::is_nothrow_convertible_v<U, value_type>)
		{
		...
		template <std::convertible_to<value_type> U>
		requires std::is_floating_point_v<value_type>
		constexpr static bool operator_less_equal_than(value_type v1, U v2, value_type epsilon = FLT_EPSILON)
				noexcept(std::is_nothrow_convertible_v<U, value_type>)
		{
		...
		template <std::convertible_to<value_type> U>
		requires std::is_floating_point_v<value_type>
		constexpr static bool operator_greater_equal_than(value_type v1, U v2, value_type epsilon = FLT_EPSILON)
				noexcept(std::is_nothrow_convertible_v<U, value_type>)
		{
	...
	*/
	...
	constexpr auto equal(const T1& t1, const T2& t2, std::type_identity_t<math_value_type<T1>> epsilon = FLT_EPSILON)
			noexcept(noexcept(
					operator_base<bool>(
							std::declval<const T1&>(),
							std::declval<const T2&>(),
	...
	*/
	template <math_type_t T1, not_math_type_t T2>
	requires std::is_floating_point_v<math_value_type<T1>>
	constexpr auto equal(const T1& t1, T2 t2, std::type_identity_t<math_value_type<T1>> epsilon = FLT_EPSILON)
			noexcept(noexcept(
					operator_base<bool>(
							std::declval<const T1&>(),
							std::declval<T2>(),
	...
	*/
	template <not_math_type_t T1, math_type_t T2>
	requires std::is_floating_point_v<math_value_type<T1>>
	constexpr auto equal(T1 t1, const T2& t2, std::type_identity_t<math_value_type<T1>> epsilon = FLT_EPSILON)
			noexcept(noexcept(
					operator_base<bool>(
							std::declval<const T2&>(),
							std::declval<T1>(),
	...
	*/
	template <typename T1, math_same_type_and_size_ignore_view_t<T1> T2>
	requires std::is_floating_point_v<math_value_type<T1>>
	constexpr auto not_equal(const T1& t1, const T2& t2, std::type_identity_t<math_value_type<T1>> epsilon = FLT_EPSILON)
			noexcept(noexcept(
					make_not(
							std::declval<std::add_lvalue_reference_t<decltype(
									equal(
	...
	*/
	template <math_type_t T1, not_math_type_t T2>
	requires std::is_floating_point_v<math_value_type<T1>>
	constexpr auto not_equal(const T1& t1, T2 t2, std::type_identity_t<math_value_type<T1>> epsilon = FLT_EPSILON)
			noexcept(noexcept(
					make_not(
							std::declval<std::add_lvalue_reference_t<decltype(
									equal(
	...
	*/
	template <not_math_type_t T1, math_type_t T2>
	requires std::is_floating_point_v<math_value_type<T1>>
	constexpr auto not_equal(T1 t1, const T2& t2, std::type_identity_t<math_value_type<T1>> epsilon = FLT_EPSILON)
			noexcept(noexcept(
					make_not(
							std::declval<std::add_lvalue_reference_t<decltype(
									equal(
	...
	*/
	...
	constexpr auto less_equal(
			...
			std::type_identity_t<math_value_type<T1>> epsilon = FLT_EPSILON
			)
			noexcept(noexcept(
					operator_base<bool>(
							std::declval<const T1&>(),
