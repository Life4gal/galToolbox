...
TEST(TestMath, TestVectorLoad3)
{
	...
	constexpr auto			u32_one_tier1  = make_one_tier_container<uint4>(u1, u2, u3);
	auto					u32_one_tier2  = make_one_tier_container<uint4>(u1, u2, u3);
	constexpr auto			u32a_one_tier1 = make_one_tier_container<uint4a>(u1, u2, u3);
	auto					u32a_one_tier2 = make_one_tier_container<uint4a>(u1, u2, u3);

	constexpr auto			i32_one_tier1  = make_one_tier_container<int4>(u1, u2, u3);
	auto					i32_one_tier2  = make_one_tier_container<int4>(u1, u2, u3);
	constexpr auto			i32a_one_tier1 = make_one_tier_container<int4a>(u1, u2, u3);
	auto					i32a_one_tier2 = make_one_tier_container<int4a>(u1, u2, u3);

	constexpr auto			f32_one_tier1  = make_one_tier_container<float4>(f1, f2, f3);
	auto					f32_one_tier2  = make_one_tier_container<float4>(f1, f2, f3);
	constexpr auto			f32a_one_tier1 = make_one_tier_container<float4a>(f1, f2, f3);
	auto					f32a_one_tier2 = make_one_tier_container<float4a>(f1, f2, f3);
...
TEST(TestMath, TestVectorLoad2)
{
	...
	constexpr auto			u32_one_tier1  = make_one_tier_container<uint4>(u1, u2);
	auto					u32_one_tier2  = make_one_tier_container<uint4>(u1, u2);
	constexpr auto			u32a_one_tier1 = make_one_tier_container<uint4a>(u1, u2);
	auto					u32a_one_tier2 = make_one_tier_container<uint4a>(u1, u2);

	constexpr auto			i32_one_tier1  = make_one_tier_container<int4>(u1, u2);
	auto					i32_one_tier2  = make_one_tier_container<int4>(u1, u2);
	constexpr auto			i32a_one_tier1 = make_one_tier_container<int4a>(u1, u2);
	auto					i32a_one_tier2 = make_one_tier_container<int4a>(u1, u2);

	constexpr auto			f32_one_tier1  = make_one_tier_container<float4>(f1, f2);
	auto					f32_one_tier2  = make_one_tier_container<float4>(f1, f2);
	constexpr auto			f32a_one_tier1 = make_one_tier_container<float4a>(f1, f2);
	auto					f32a_one_tier2 = make_one_tier_container<float4a>(f1, f2);
