export module gal.toolbox.random;
...
namespace gal::toolbox {
	export {
		...
		class xor_shift_rotate_256_star_star_engine;
		class xor_shift_rotate_128_plus_engine;
		class xor_shift_rotate_128_plus_plus_engine;
		class xor_shift_rotate_128_star_star_engine;
		class xor_rotate_shift_rotate_128_plus_engine;
		class xor_rotate_shift_rotate_128_plus_plus_engine;
		class xor_rotate_shift_rotate_128_star_star_engine;
	}
	...
	public:
		...
		constexpr engine_base_reference operator=(engine_base_rreference) noexcept = default;
